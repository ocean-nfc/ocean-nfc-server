...
export class PinManager {
   ...
   * @returns The new pin
   */
  public static async createNewPin(clientID: string): Promise<string> {
   ...
   */
  public static async verifyPinHash(pin: string, pinhash: string): Promise<boolean> {
   ...
   */
  private static async generatePinHash(pin: string, salt?: string): Promise<string> {
